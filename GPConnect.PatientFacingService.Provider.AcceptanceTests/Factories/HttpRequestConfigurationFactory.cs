namespace GPConnect.PatientFacingService.Provider.AcceptanceTests.Factories
{
    ...
    public class HttpRequestConfigurationFactory
    {
        ...
        {
            _httpRequestConfiguration.HttpMethod = HttpMethod.Get;
            _httpRequestConfiguration.RequestUrl = "documents/Patient/";
        ...
        {
            _httpRequestConfiguration.HttpMethod = HttpMethod.Get;
            _httpRequestConfiguration.RequestUrl = "documents/Patient/" + _httpRequestConfiguration.GetRequestId;
        ...
        private static HttpRequestConfiguration DocumentsPatientSearchConfiguration()
        {
          ...
          //  _httpRequestConfiguration.RequestUrl = "documents";
            _httpRequestConfiguration.RequestUrl = "documents/Patient/";

...
// RMB 29/10/2018
        ...
        [Given(@"I add a Patient parameter with NHS number ""([^""]*)""")]
        public void IaddaPatientparameterwithNHSnumber(string value)
        {
            _httpContext.HttpRequestConfiguration.RequestParameters.AddParameter("Patient", GlobalContext.PatientNhsNumberMap[value]);
        }

using System.Linq;
using GPConnect.PatientFacingService.Provider.AcceptanceTests.Helpers;
...
namespace GPConnect.PatientFacingService.Provider.AcceptanceTests.Steps
{
    ...
    public class HttpRequestConfigurationSteps : Steps
    {
        ...
        [Given(@"I set the Find Patient ID in the request to ""([^""]*)""")]
        public void SetTheFindPatientIDInTheRequestTo(string patientID)
        {

            _httpContext.HttpRequestConfiguration.GetRequestId = GlobalContext.PatientNhsNumberMap[patientID];
        ...
        {
            string patient1= GlobalContext.PatientNhsNumberMap[patientID1];
            string patient2 = GlobalContext.PatientNhsNumberMap[patiendID2];

            _httpContext.HttpRequestConfiguration.GetRequestId = (patient1 + "/" + patient2);
        ...
        public void SetTheReadOperationLogicalIdentifierUsedInTheRequestTo(string logicalId)
        {
            ...
            _httpContext.HttpRequestConfiguration.GetRequestId = GlobalContext.PatientNhsNumberMap[logicalId];

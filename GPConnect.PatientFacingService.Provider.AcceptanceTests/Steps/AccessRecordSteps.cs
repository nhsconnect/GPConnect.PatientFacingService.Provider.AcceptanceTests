namespace GPConnect.PatientFacingService.Provider.AcceptanceTests.Steps
{
    ...
    using GPConnect.PatientFacingService.Provider.AcceptanceTests.Cache.ValueSet;
    ...
    public sealed class AccessRecordSteps : BaseSteps
    {
        ...
        {
            Bundle.Id.ShouldBe(GlobalContext.X_Request_ID, "Fail : Bundle ID should match the Request Header X_Request_ID");
            Logger.Log.WriteLine("Info : Bundle ID matched Request XRequestID");
        ...
        [Then(@"The Bundle id should match the XRequestID")]
        public void TheBundleidshouldmatchtheXRequestID()
        {
            Bundle.Id.ShouldBe(GlobalContext.X_Request_ID, "Fail : Bundle ID should match the Request Header X_Request_ID");
            Logger.Log.WriteLine("Info : Bundle ID matched Request X_Request_ID");
        }
